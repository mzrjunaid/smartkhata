...
final lenderRemindersProvider = FutureProvider<Map<String, List<ReminderItem>>>(
  (ref) async {
    ...
    List<ReminderItem> parse(List<dynamic> rows) {
    ...
    return {
      'pending': parse(pendingResponse as List),
      'rejected': parse(rejectedResponse as List),
      'missed': parse(missedResponse as List),
    };
  },
);
